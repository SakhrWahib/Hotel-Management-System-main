...
<div class="addroomsection">
    <form action="" method="POST">
        ...
        <input type="text" name="staffname" class="form-control" placeholder="أدخل الاسم">

        <label for="staffwork">العمل:</label>
        <select name="staffwork" class="form-control">
            ...
            <option value="weighter">نادل</option>
        </select>

        <button type="submit" class="btn btn-success" name="addstaff">إضافة موظف</button>
    </form>
