...
<body >
   <div class="databox">
        ...
        <div class="box profitbox">
          <h2>الأرباح</h2>  
          <h1><?php echo $tot?> <span>SAR</span></h1>
        </div>
    </div>
    <div class="chartbox">
        <div class="bookroomchart">
            <canvas id="bookroomchart"></canvas>
            <h3 style="text-align: center;margin:10px 0;">الغرف المحجوزة</h3>
        </div>
        <div class="profitchart">
            <div id="profitchart"></div>
            <h3 style="text-align: center;margin:10px 0;">الأرباح</h3>
        </div>
    </div>
</body>
