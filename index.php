...
<div class="auth_container">
    ...
    <div id="Log_in">
        <h2>تسجيل الدخول</h2>
        <div class="role_btn">
            <div class="btns active">مستخدم</div>
            <div class="btns">موظف</div>
        </div>
        ...
        <form class="user_login authsection active" id="userlogin" action="" method="POST">
            ...
            <button type="submit" name="user_login_submit" class="auth_btn">تسجيل الدخول</button>

            <div class="footer_line">
                <h6>لا تملك حساب؟ <span class="page_move_btn" onclick="signuppage()">سجل الآن</span></h6>
            </div>
        </form>
        ...
        <form class="employee_login authsection" id="employeelogin" action="" method="POST">
            ...
            <button type="submit" name="Emp_login_submit" class="auth_btn">تسجيل الدخول</button>
        </form>
    ...
    <div id="sign_up">
        ...
        <form class="user_signup" id="usersignup" action="" method="POST">
            ...
            <button type="submit" name="user_signup_submit" class="auth_btn">سجل الآن</button>

            <div class="footer_line">
                <h6>هل لديك حساب؟ <span class="page_move_btn" onclick="loginpage()">تسجيل الدخول</span></h6>
            </div>
        </form>
    </div>
    </section>
